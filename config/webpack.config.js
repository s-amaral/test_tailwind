...
// Webpack overrides for web3 stuff
const configOverrides = require("./webpack/config-overrides");
  ...
  return {
    ...
    module: {
      ...
      rules: [
        ...
        shouldUseSourceMap && {
          enforce: "pre",
          exclude: /(@babel(?:\/|\\{1,2})runtime|@walletconnect)/,
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              test: /\.(js|mjs|jsx|ts|tsx|^stories\.tsx)$/,
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        templateParameters: {
          analyticsId: isEnvProduction ? "G-D8VJE77604" : "G-K77FZG1NFE",
        },
        ...(isEnvProduction
          ? {
              minify: {
...
module.exports = (webpackEnv) => configOverrides(config(webpackEnv));
